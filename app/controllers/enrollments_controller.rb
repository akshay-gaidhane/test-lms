class EnrollmentsController < ApplicationController
  ...
  def index
    @enrollments = Enrollment.enrollment_list(current_user)
  end
  ...
  def create
    ...
    @enrollment.sender_id = current_user.id
  ...
  private
    ...
    def enrollment_params
      params.require(:enrollment).permit(:sender_id, :batch_id, :monitored_by, :status)
    end
